...
def parse_arguments(pretrained_model_folder, init_dataset):
    ...
    parser.add_argument('--dataset_text_folder', required=False, default=init_dataset, help='')
    ...
    parser.add_argument('--load_all_pretrained_token_embeddings', required=False, default=True, help='')
    ...
    parser.add_argument('--pretrained_model_folder', required=False, default=pretrained_model_folder, help='')
    ...
    parser.add_argument('--token_embedding_dimension', required=False, default=100, help='')
    ...
    parser.add_argument('--train_model', required=False, default=False, help='')
    ...
    parser.add_argument('--use_pretrained_model', required=False, default=True, help='')
